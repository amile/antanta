...
/***/ function(module, exports, __webpack_require__) {
	...
	SlideshowProject.prototype.isTranslate = function (reverse) {
		...
		(0, _jquery2.default)(this.sliderWrapper).removeClass('translate_none');
		setTimeout(function () {
	...
	SlideshowProject.prototype.userTouch = function () {
		...
		var touchmove = function touchmove(e) {
			...
			if (Math.abs(dist) >= halfSlideWidth) {
				e.preventDefault();
			}
		};
		...
		var _loop3 = function _loop3(slide) {
			halfSlideWidth = self.sliderWrapper.offsetWidth / 2;
			self.slides[slide].addEventListener('touchstart', touchstart);
			self.slides[slide].addEventListener('touchmove', touchmove);
			self.slides[slide].addEventListener('touchend', function (e) {
				touchend.bind(_this5)(e, slide);
				// e.preventDefault();
			});
		};
	
		for (var slide = 0; slide < self.slides.length; slide++) {
			_loop3(slide);
		}
	};
