...
/***/ function(module, exports, __webpack_require__) {
	...
	window.onload = function () {
		var projectSlider = new _project2.default('projects__carousel');
		projectSlider.intervalSlideshow();
		var slider = new _slideshow2.default('slideshow');
		slider.intervalSlideshow();
		var serviceSlider = new _service2.default('services__carousel');
...
/***/ function(module, exports, __webpack_require__) {
	...
	SlideshowProject.prototype.changeSlideOrder = function (click, reverse, bullet) {
		...
		Array.prototype.forEach.call(this.slides, function (slide, index) {
			if (index < _this2.prevSlide) {
				slide.style.order = String(_this2.numSlides - (_this2.prevSlide - index));
			} else if (index > _this2.prevSlide) {
				slide.style.order = String(index - _this2.prevSlide);
			}
		});
	};
	
	SlideshowProject.prototype.isTranslate = function (touch, reverse) {
		var _this3 = this;
	
		if (reverse) {
			(0, _jquery2.default)(this.sliderWrapper).addClass('is-transform_reverse');
		}
		(0, _jquery2.default)(this.slider).addClass('background_none');
		(0, _jquery2.default)(this.sliderWrapper).removeClass('translate_none translate_none-touch');
		if (touch) {
			setTimeout(function () {
				return (0, _jquery2.default)(_this3.sliderWrapper).addClass('translate_none-touch');
			}, 50);
		} else {
			setTimeout(function () {
				return (0, _jquery2.default)(_this3.sliderWrapper).addClass('translate_none');
			}, 50);
		}
		setTimeout(function () {
			return (0, _jquery2.default)(_this3.slider).removeClass('background_none');
		}, 1000);
		this.bullets[this.currentSlide].className = this.bulletClassName;
		this.bulletsIn[this.currentSlide].className = this.bulletInClassName;
	...
	SlideshowProject.prototype.nextSlide = function () {
		...
		Array.prototype.forEach.call(this.slides, function (slide, index) {
			if (index === _this4.prevSlide) {
				slide.style.order = String(_this4.numSlides - 1);
			} else {
				var order = slide.style.order;
				slide.style.order = String(order - 1);
			}
		});
		(0, _jquery2.default)(this.slider).addClass('background_none');
		(0, _jquery2.default)(this.sliderWrapper).removeClass('is-transform_reverse');
		(0, _jquery2.default)(this.sliderWrapper).removeClass('translate_none translate_none-touch');
		setTimeout(function () {
			return (0, _jquery2.default)(_this4.sliderWrapper).addClass('translate_none');
		}, 50);
		setTimeout(function () {
			return (0, _jquery2.default)(_this4.slider).removeClass('background_none');
		}, 1000);
	...
	SlideshowProject.prototype.userClickOrigin = function () {
		...
		var _loop = function _loop(bullet) {
			self.bullets[bullet].addEventListener('click', function () {
				clearInterval(self.interval);
				(0, _jquery2.default)(self.sliderWrapper).removeClass('is-transform is-transform_reverse');
				self.prevSlide = bullet - 1 >= 0 ? bullet - 1 : self.numSlides - 1;
				self.slides[self.prevSlide].style.order = '0';
				Array.prototype.forEach.call(self.slides, function (slide, index) {
				...
				if (bullet !== self.currentSlide) {
					(0, _jquery2.default)(self.slider).addClass('background_none');
					if (bullet < self.currentSlide) {
						(0, _jquery2.default)(self.sliderWrapper).addClass('is-transform_reverse');
					}
					(0, _jquery2.default)(self.sliderWrapper).removeClass('translate_none');
					setTimeout(function () {
						return (0, _jquery2.default)(self.sliderWrapper).addClass('translate_none');
					}, 50);
					setTimeout(function () {
						return (0, _jquery2.default)(self.slider).removeClass('background_none');
					}, 1000);
				}
				self.bullets[self.currentSlide].className = self.bulletClassName;
				self.bulletsIn[self.currentSlide].className = self.bulletInClassName;
		...
		for (var bullet = 0; bullet < self.bullets.length; bullet++) {
			_loop(bullet);
		}
	};
	...
	SlideshowProject.prototype.userClick = function () {
		...
		var _loop2 = function _loop2(bullet) {
			self.bullets[bullet].addEventListener('click', function () {
	   	...
	   	Array.prototype.forEach.call(self.slides, (slide, index) => {
	   		if (index < self.prevSlide) {
				...
				var isTranslate = function isTranslate(reverse) {
					if (reverse) {
						(0, _jquery2.default)(self.sliderWrapper).addClass('is-transform_reverse');
					}
					(0, _jquery2.default)(self.slider).addClass('background_none');
					(0, _jquery2.default)(self.sliderWrapper).removeClass('translate_none translate_none-touch');
					setTimeout(function () {
						return (0, _jquery2.default)(self.sliderWrapper).addClass('translate_none');
					}, 50);
					setTimeout(function () {
				...
				if (bullet > self.currentSlide) {
					if (bullet - self.currentSlide > 1) {
						...
						isTranslate(false);
						setTimeout(function () {
							return self.changeSlideOrder(true, false, bullet);
						}, 1000);
					} else {
	...
	SlideshowProject.prototype.userTouch = function () {
		...
		var touchmove = function touchmove(e) {
			var touchObj = e.changedTouches[0];
			distX = startX - parseInt(touchObj.clientX, 10);
			distY = startY - parseInt(touchObj.clientY, 10);
			if (Math.abs(distY) < 150) {
				e.preventDefault();
			}
		};
		var touchend = function touchend(e, slide) {
			halfSlideWidth = this.sliderWrapper.offsetWidth / 2;
			(0, _jquery2.default)(this.sliderWrapper).removeClass('is-transform is-transform_reverse');
			if (Math.abs(distX) >= halfSlideWidth && distX > 0) {
				clearInterval(this.interval);
				this.changeSlideOrder(false, false, slide);
				this.isTranslate(true, false);
				e.preventDefault();
			} else if (Math.abs(distX) >= halfSlideWidth && distX < 0) {
				clearInterval(this.interval);
				this.changeSlideOrder(false, true, slide);
				this.isTranslate(true, true);
				e.preventDefault();
			}
		};
		...
		this.sliderWrapper.addEventListener('touchend', function (e) {
			touchend.bind(_this5)(e, _this5.currentSlide);
			// e.preventDefault();
		});
	};
	
	exports.default = SlideshowProject;
...
/***/ function(module, exports, __webpack_require__) {
	...
	SlideshowServices.prototype.nextIndex = function (index, numSlides) {
		var nextInd = index + 1 <= numSlides - 1 ? index + 1 : 0;
		return nextInd;
	};
	SlideshowServices.prototype.prevIndex = function (index, numSlides) {
		var prevInd = index - 1 >= 0 ? index - 1 : numSlides - 1;
		return prevInd;
	};
	...
	SlideshowServices.prototype.changeCurrentSlide = function (reverse) {
		...
		(0, _jquery2.default)(this.sliderWrapper).removeClass('is-reversing');
		(0, _jquery2.default)(this.slides[this.prevSlide]).removeClass('previous');
		if (reverse) {
			this.prevSlide = this.prevIndex(this.prevSlide, this.numSlides);
			(0, _jquery2.default)(this.sliderWrapper).addClass('is-reversing');
		} else {
			this.prevSlide = this.nextIndex(this.prevSlide, this.numSlides);
		}
		(0, _jquery2.default)(this.slides[this.prevSlide]).addClass('previous');
		this.slides[this.prevSlide].style.order = '0';
		Array.prototype.forEach.call(this.slides, function (slide, index) {
			if (index < _this.prevSlide) {
				slide.style.order = String(_this.numSlides - (_this.prevSlide - index));
			} else if (index > _this.prevSlide) {
				slide.style.order = String(index - _this.prevSlide);
			}
		});
		(0, _jquery2.default)(this.sliderWrapper).removeClass('transform_none');
		setTimeout(function () {
			return (0, _jquery2.default)(_this.sliderWrapper).addClass('transform_none');
		}, 50);
	};
	
	SlideshowServices.prototype.userClick = function () {
	
		var nextIndex = function nextIndex(index, numSlides) {
			var nextInd = index + 1 < numSlides - 1 ? index + 1 : 0;
			return nextInd;
		};
		var prevIndex = function prevIndex(index, numSlides) {
			var prevInd = index - 1 >= 0 ? index - 1 : numSlides - 1;
			return prevInd;
		};
		var self = this;
		this.bulletNext.addEventListener('click', function () {
			(0, _jquery2.default)(self.sliderWrapper).removeClass('is-reversing');
			(0, _jquery2.default)(self.slides[self.prevSlide]).removeClass('previous');
			self.prevSlide = nextIndex(self.prevSlide, self.numSlides);
			(0, _jquery2.default)(self.slides[self.prevSlide]).addClass('previous');
			self.slides[self.prevSlide].style.order = '0';
			Array.prototype.forEach.call(self.slides, function (slide, index) {
				if (index < self.prevSlide) {
					slide.style.order = String(self.numSlides - (self.prevSlide - index));
			...
			(0, _jquery2.default)(self.sliderWrapper).removeClass('transform_none');
			setTimeout(function () {
				return (0, _jquery2.default)(self.sliderWrapper).addClass('transform_none');
			}, 50);
		});
		this.bulletPrev.addEventListener('click', function () {
			(0, _jquery2.default)(self.sliderWrapper).addClass('is-reversing');
			(0, _jquery2.default)(self.slides[self.prevSlide]).removeClass('previous');
	...
	SlideshowServices.prototype.userTouch = function () {
		...
		var touchend = function touchend(e) {
			...
			halfSlideWidth = this.sliderWrapper.offsetWidth / 2;
			if (Math.abs(distX) >= halfSlideWidth && distX > 0) {
				console.log('hello touch false', distX, halfSlideWidth);
				clearInterval(this.interval);
				this.changeCurrentSlide(false);
				e.preventDefault();
			} else if (Math.abs(distX) >= halfSlideWidth && distX < 0) {
				console.log('hello touch true', distX, halfSlideWidth);
				clearInterval(this.interval);
		...
		this.sliderWrapper.addEventListener('touchmove', touchmove);
		this.sliderWrapper.addEventListener('touchend', function (e) {
			touchend.bind(_this2)(e);
		});
	};
	
	exports.default = SlideshowServices;
